...
public class AccountController {
    public static void main(String[] args) {
        ...
        // Aufgabe: wie könnte der Controller modifiziert werden, damit fix(String):String und validate(String):boolean
        // für die Eingabe genutzt wird.
        
        iban = Account.fix(iban);
        if(!Account.validate(iban)) {
            System.out.println("IBAN " + iban + " stimmt nicht?");
            return;
        }
